<div class="form-group">
    <label class="control-label" for="last-name">Category Master 
...
<div class="form-group">
    <div class="">
        {!!link_to('/backoffice/subcategorias', $title = 'Cancel', $attributes = array('class'=>'btn btn-default'), $secure = null)!!}
